...
for i in range(5):
    ...
    indices = active_learning_sample(data_pool, 'core-set', 25, trainer)
    ...
    results['core-set'].append(result['eval_f1'])
    print(results)

    # 평가 결과를 CSV 파일로 저장
    save_results_to_csv(results, link + '/core_set_results.csv')
